...
export default function KuwaitMarket() {
  usePageMeta({ title: 'SEO Agency Kuwait City — Rank #1 in Kuwait | upranked.io', description: "Rank higher in Kuwait City searches with Arabic & English SEO, Google Business Profile, and bilingual content built for Kuwait's commercial market. APEX Framework by Sam.", schema, schemaId: 'kuwait-market-schema' });
  return (
        ...
        <div className="container-premium max-w-4xl">
          <div className="bg-navy border border-border rounded-xl p-8 flex flex-col md:flex-row gap-8 items-start mb-12">
            <img
              ...
              alt="Sam — GCC SEO strategist specializing in Kuwait City Arabic SEO at upranked.io"
              width={400}
              height={640}
              loading="lazy"
              decoding="async"
