...
export default function LocalSEO() {
  usePageMeta({ title: 'Local SEO Dubai & GCC — Near-Me Search & Google Business Profile', description: 'Local SEO for Dubai UAE, Riyadh KSA, Kuwait City, Manama Bahrain, London & New York. Google Business Profile, near-me optimization, local citations — APEX Framework by Sam.', schema, schemaId: 'local-seo-schema' });
  return (
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="flex justify-center items-center">
              <div className="w-full max-w-[800px]">
                <img
                  ...
                  alt="SERP positions chart showing local SEO rankings for GCC businesses in Dubai, Riyadh, Kuwait, and Bahrain — upranked.io"
                  width={800}
                  height={600}
                  loading="eager"
                  decoding="async"
