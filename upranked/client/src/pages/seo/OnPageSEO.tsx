  ...
  '@graph': [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Does upranked.io offer on-page SEO near me in Dubai?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. upranked.io is Dubai-based and offers on-page SEO for businesses across the GCC — including Dubai, Abu Dhabi, Riyadh, Kuwait City, and Manama — as well as London and New York. All on-page work is led by Sam using the APEX Framework.' } },
      ],
    },
    {
      '@type': 'BreadcrumbList',
...
const faqs = [
  ...
  { q: 'Does upranked.io offer on-page SEO near me in Dubai?', a: 'Yes. upranked.io is Dubai-based and offers on-page SEO for businesses across the GCC — including Dubai, Abu Dhabi, Riyadh, Kuwait City, and Manama — as well as London and New York. All on-page work is led by Sam using the APEX Framework.' },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="flex justify-center items-center">
              <div className="w-full max-w-[800px]">
                <img
                  src="/heroes/09-onpage-seo.svg"
                  alt="On-page SEO dashboard showing title tags, keyword rankings, and content optimization signals for GCC businesses — upranked.io Dubai"
                  width={800}
                  height={600}
                  loading="eager"
                  decoding="async"
