    ...
    faqs: [
      {
        ...
        a: 'upranked.io is a premium Growth Intelligence Lab founded by Sam, specializing in SEO, business strategy, and digital growth for high-value businesses across the GCC (Dubai UAE, Riyadh KSA, Kuwait City, Manama Bahrain) and global markets including London UK and New York USA.',
      },
      {
      ...
      {
        q: 'Who is Sam?',
        a: 'Sam is the founder of upranked.io and creator of the APEX Framework™. He personally leads all client strategy engagements with deep expertise in GCC market SEO, business positioning, and digital growth intelligence. Sam works directly with clients in Dubai, Riyadh, Kuwait City, Manama, London, and New York.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Yes. upranked.io is Dubai-based and GCC-focused. Sam is available for in-person strategy sessions in Dubai and remote engagements across all GCC markets — Riyadh, Kuwait City, and Manama. London and New York clients are served remotely.',
      },
    ],
  },
  {
    ...
    faqs: [
      {
        q: 'What is a business consultation with Sam?',
    ...
    faqs: [
      {
        ...
        a: 'Book a free 30-minute strategy call via the contact page, WhatsApp (Contact Us), or email (uprankedio@gmail.com). No commitment required. Sam will review your current position and give you an honest assessment of the opportunity — and whether upranked.io is the right fit for your business.',
      },
      {
      ...
      },
      {
        ...
        a: 'Sam leads every engagement — strategy, direction, and client communication always flows directly through the founder. For execution work (content, technical SEO, development), we have a specialist team. You will never be handed off to an account manager who wasn\'t in the original strategy conversation.',
      },
      {
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <div className="bg-dark-gray border-l-4 border-accent rounded-r-xl p-5 mb-8">
                ...
                <p className="text-text-secondary text-sm leading-relaxed">
                  upranked.io is a premium SEO agency and Growth Intelligence Lab founded by Sam. We apply the proprietary APEX Framework™ — Audit, Position, Execute, Expand — to help high-value businesses in Dubai, Riyadh, Kuwait, Bahrain, London, and New York achieve compounding organic growth. We specialize in medical SEO, industrial SEO, business SEO, and Growth Intelligence services including business consultation, custom tools, websites, and market positioning.
                </p>
              </div>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} viewport={{ once: true }}>
                <div className="bg-dark-gray border border-accent/30 rounded-2xl p-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-6">
                    <img src="/favicon.svg" alt="Sam — Founder upranked.io, GCC SEO Expert" width={80} height={80} loading="lazy" className="w-20 h-20 rounded-full object-cover object-top flex-shrink-0 border-2 border-accent/30" decoding="async" />
                    <div>
        ...
        <div className="container-premium text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
            ...
            <p className="text-xl text-text-secondary mb-8 max-w-2xl mx-auto">
              Book a free 30-minute strategy call with Sam. Ask anything about your specific situation — no obligations, no pressure. Available for businesses in Dubai, Riyadh, Kuwait, Bahrain, London, and New York.
            </p>
