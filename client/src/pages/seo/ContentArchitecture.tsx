          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="flex justify-center items-start pt-4 lg:pt-16">
              <img
                ...
                alt="Sam Hamouda — SEO content architecture specialist in Dubai designing topic clusters and pillar pages for GCC businesses at upranked.io"
                width={480}
                height={640}
                loading="eager"
                decoding="async"
