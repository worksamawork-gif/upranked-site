...
const schema = {
  ...
  '@graph': [
    { '@type': 'Service', name: 'SEO Agency Dubai UAE — Search Optimization for Dubai Businesses', description: 'SEO services for businesses in Dubai UAE — bilingual Arabic-English SEO, Google Business Profile, local and technical SEO by upranked.io. APEX Framework by Sam.', provider: { '@type': 'Organization', name: 'upranked.io', url: 'https://upranked.io' }, url: 'https://upranked.io/markets/gcc/uae/dubai', areaServed: ['Dubai', 'Abu Dhabi', 'Sharjah', 'UAE'] },
    { '@type': 'FAQPage', mainEntity: [
      ...
      { '@type': 'Question', name: 'Do you offer SEO services near me in Dubai?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. upranked.io is based in Dubai, UAE and serves businesses across Dubai, Abu Dhabi, Sharjah, and the wider UAE. Sam personally oversees all Dubai SEO engagements. Book a free APEX Diagnostic call to discuss your Dubai SEO strategy.' } },
...
const faqs = [
  ...
  { q: 'Do you offer SEO services near me in Dubai?', a: 'Yes. upranked.io is based in Dubai, UAE and serves businesses across Dubai, Abu Dhabi, Sharjah, and the wider UAE. Sam personally oversees all Dubai SEO engagements. Book a free APEX Diagnostic call to discuss your Dubai SEO strategy.' },
        ...
        <div className="container-premium max-w-3xl">
          ...
          <div className="mt-10 p-5 bg-dark-gray border border-accent/20 rounded-xl flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="flex-1">
              ...
              <p className="text-white font-semibold text-sm mb-1">Arabic SEO Agency in Dubai & UAE — What to Look For (And What to Avoid)</p>
              <p className="text-text-secondary text-xs leading-relaxed">40–50% of UAE searches are in Arabic. What a real Arabic SEO agency delivers, what questions to ask, and the red flags to avoid before hiring.</p>
            </div>
            <Link href="/blog/arabic-seo-agency-dubai-uae/">
      ...
      <section className="section-padding bg-dark-gray">
        <div className="container-premium max-w-4xl">
          <div className="bg-navy border border-border rounded-xl p-8 flex flex-col md:flex-row gap-8 items-start mb-12">
            <img
              src="/favicon.svg"
              alt="Sam — SEO consultant serving Dubai and UAE businesses at upranked.io"
              width={400}
              height={640}
              loading="lazy"
              decoding="async"
