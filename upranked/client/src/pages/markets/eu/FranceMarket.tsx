...
const schema = {
  ...
  '@graph': [
    { '@type': 'Service', name: 'SEO Agency France — Paris & French Market Search Optimization', description: 'SEO services for businesses in France — technical SEO, content strategy, and GCC-to-France expansion SEO by upranked.io. APEX Framework by Sam Hamouda.', provider: { '@type': 'Organization', name: 'upranked.io', url: 'https://upranked.io' }, url: 'https://upranked.io/markets/eu/france', areaServed: ['Paris', 'Lyon', 'Marseille', 'France'] },
...
export default function FranceMarket() {
  usePageMeta({ title: 'SEO Agency France — Paris & French Market Search Optimization', description: 'SEO agency for France and Paris. Technical SEO, content architecture, luxury & financial SEO, and GCC-to-France expansion — APEX Framework by Sam Hamouda at upranked.io.', schema, schemaId: 'france-market-schema' });
  return (
      ...
      <section className="section-padding bg-dark-gray">
        <div className="container-premium max-w-4xl">
          <div className="bg-navy border border-border rounded-xl p-8 flex flex-col md:flex-row gap-8 items-start mb-12">
            <img src="/images/sam-hamouda-seo-consultant-dubai.webp" alt="Sam Hamouda — SEO strategist at upranked.io serving France and GCC businesses" width={112} height={176} loading="lazy" decoding="async" className="w-28 h-44 rounded-xl object-cover object-top flex-shrink-0" />
            <div>
