          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <div className="prose prose-invert max-w-none space-y-8 text-text-secondary leading-relaxed">
              <section>
                ...
                <p>upranked.io is a premium SEO agency based in Dubai, UAE, operated by Sam Hamouda. We provide SEO strategy and digital growth services to businesses across the GCC and globally. Contact: <a href="mailto:Sam@upranked.io" className="text-accent hover:underline">Sam@upranked.io</a></p>
              </section>
