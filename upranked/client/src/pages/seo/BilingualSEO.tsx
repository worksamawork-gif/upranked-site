...
export default function BilingualSEO() {
  usePageMeta({ title: 'Bilingual SEO Dubai — Arabic & English Search Optimization GCC', description: 'Bilingual EN/AR SEO for Dubai UAE, Riyadh KSA, Kuwait City, Manama Bahrain. Native Arabic keyword research, RTL architecture, hreflang — APEX Framework by Sam Hamouda.', schema, schemaId: 'bilingual-seo-schema' });
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="flex justify-center items-start pt-4 lg:pt-16">
              <img
                ...
                alt="Sam Hamouda — bilingual Arabic English SEO strategist in Dubai building EN and AR search visibility for GCC businesses at upranked.io"
                width={480}
                height={640}
                loading="eager"
                decoding="async"
