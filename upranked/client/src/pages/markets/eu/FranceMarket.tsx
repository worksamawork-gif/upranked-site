...
export default function FranceMarket() {
  usePageMeta({ title: 'SEO Agency France | Paris & French Market SEO', description: 'SEO agency for France and Paris. Technical SEO, content architecture, luxury & financial SEO, and GCC-to-France expansion — APEX Framework by Sam at upranked.io.', schema, schemaId: 'france-market-schema' });
  return (
