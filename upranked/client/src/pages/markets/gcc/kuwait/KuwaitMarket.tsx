...
export default function KuwaitMarket() {
  usePageMeta({ title: 'SEO Agency Kuwait City | Rank #1 in Kuwait', description: "Rank higher in Kuwait City searches with Arabic & English SEO, Google Business Profile, and bilingual content built for Kuwait's commercial market. APEX Framework by Sam.", schema, schemaId: 'kuwait-market-schema' });
  return (
