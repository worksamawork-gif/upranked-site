...
export default function SEOAnalytics() {
  usePageMeta({ title: 'SEO Analytics & Reporting Dubai & GCC — Rank Tracking & Revenue Attribution', description: 'SEO analytics and reporting for Dubai UAE, Riyadh KSA, Kuwait, Bahrain, London & New York. GCC rank tracking, GSC integration, revenue attribution — APEX Framework by Sam Hamouda.', schema, schemaId: 'seo-analytics-schema' });
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="flex justify-center items-start pt-4 lg:pt-16">
              <img
                ...
                alt="Sam Hamouda — SEO analytics consultant in Dubai tracking GCC keyword rankings and attributing organic revenue for businesses at upranked.io"
                width={480}
                height={640}
                loading="eager"
                decoding="async"
