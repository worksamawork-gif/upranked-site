...
export default function SchemaSEO() {
  usePageMeta({ title: 'Schema Markup & Structured Data Dubai & GCC — Rich Results SEO', description: 'Schema markup and @graph JSON-LD implementation for Dubai UAE, Riyadh KSA, Kuwait, Bahrain, London & New York. FAQPage, LocalBusiness, MedicalOrg rich results by Sam Hamouda.', schema, schemaId: 'schema-seo-schema' });
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="flex justify-center items-start pt-4 lg:pt-16">
              <img
                ...
                alt="Sam Hamouda — schema markup and structured data SEO consultant in Dubai implementing JSON-LD rich results for GCC businesses at upranked.io"
                width={480}
                height={640}
                loading="eager"
                decoding="async"
