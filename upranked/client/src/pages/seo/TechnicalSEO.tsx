...
const schema = {
  ...
  '@graph': [
    ...
    { '@type': 'FAQPage', mainEntity: [
      ...
      { '@type': 'Question', name: 'Do you offer technical SEO audits near me in Dubai?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. upranked.io offers forensic technical SEO audits for businesses across Dubai, Abu Dhabi, Riyadh, Kuwait City, Manama, London, and New York. Every audit is delivered with a prioritized fix list and Sam personally oversees all implementation.' } },
    ] },
...
const faqs = [
  ...
  { q: 'Do you offer technical SEO audits near me in Dubai?', a: 'Yes. upranked.io offers forensic technical SEO audits for businesses across Dubai, Abu Dhabi, Riyadh, Kuwait City, Manama, London, and New York. Every audit is delivered with a prioritized fix list and Sam personally oversees all implementation.' },
];
...
export default function TechnicalSEO() {
  usePageMeta({ title: 'Technical SEO Dubai & GCC — Site Architecture, Speed & Crawlability', description: 'Technical SEO audits for Dubai UAE, Riyadh KSA, Kuwait, Bahrain, London & New York. Core Web Vitals, bilingual RTL architecture, crawl fixes — APEX Framework by Sam.', schema, schemaId: 'technical-seo-schema' });
  return (
