 ...
 * SECONDARY KW: growth strategy consultant GCC, business consultant Dubai UAE, Sam Hamouda consultation
 * NEAR ME: business consultant near me Dubai, growth strategist near me UAE
 * META TITLE (60 chars): Business Consultation Dubai | Sam Hamouda | upranked.io
 * META DESC (158 chars): 1-on-1 business consultation with Sam Hamouda in Dubai & GCC. APEX Framework™ applied to your growth bottlenecks. 90-day roadmap. Book a free intro call.
...
const faqs = [
  { q: 'What is business consultation with Sam Hamouda and who is it for?', a: 'Business consultation with Sam Hamouda is a direct, founder-led strategic advisory service for business owners, marketing leaders, and founders across Dubai, the GCC, London, and New York. It is designed for companies that need senior-level strategic thinking applied to their specific growth challenge — not a generic agency package. Each engagement uses the APEX Framework™ to diagnose, position, and build an actionable 90-day growth roadmap.' },
  ...
  '@graph': [
    {
      ...
      name: 'Business Consultation Dubai — 1-on-1 with Sam Hamouda',
      serviceType: 'Business Consultation',
      description: '1-on-1 strategic business consultation with Sam Hamouda, founder of upranked.io. APEX Framework™ applied to your GCC growth challenges. 90-day roadmap delivered.',
...
export default function BusinessConsultation() {
  usePageMeta({
    title: 'Business Consultation Dubai | Sam Hamouda | upranked.io',
    description: '1-on-1 business consultation with Sam Hamouda in Dubai & GCC. APEX Framework™ applied to your growth bottlenecks. 90-day roadmap. Book a free intro call.',
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="flex justify-center items-start pt-4 lg:pt-16">
              <img
                ...
                alt="Sam Hamouda — business growth consultant and strategist in Dubai offering APEX Framework advisory for GCC businesses at upranked.io"
                width={480}
                height={640}
                loading="eager"
                decoding="async"
        ...
        <div className="container-premium max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} viewport={{ once: true }}>
            ...
            <div className="border-l-4 border-accent bg-dark-gray/80 rounded-r-xl p-6 mb-8">
              ...
              <p className="text-text-secondary leading-relaxed"><strong className="text-white">Business consultation at upranked.io</strong> is a direct, founder-led strategic advisory service where Sam Hamouda applies the APEX Framework™ — Audit → Position → Execute → Expand — to your specific growth challenge in Dubai, the GCC, London, or New York. Unlike generalist agency consultations, every session is focused on commercial outcomes: where you rank, where competitors are vulnerable, what your organic growth opportunity is, and the exact prioritised moves to capture it.</p>
            </div>
        ...
        <div className="container-premium max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} viewport={{ once: true }} className="border border-accent/30 rounded-2xl p-8 bg-navy/60">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              <img src="/images/sam-hamouda-best-seo-consultant-gcc.webp" alt="Sam Hamouda — business consultant Dubai, founder upranked.io GCC SEO strategist" width={140} height={140} loading="lazy" className="rounded-xl border border-accent/20 flex-shrink-0 w-28 h-28 sm:w-36 sm:h-36 object-cover object-top" decoding="async" />
              <div>
      ...
      <section className="section-padding bg-gradient-to-br from-navy via-dark-gray to-navy">
        <div className="container-premium max-w-3xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
            ...
            <p className="text-text-secondary mb-6 leading-relaxed">Book a free 30-minute APEX Diagnostic with Sam Hamouda. Come with your biggest growth challenge — leave with a clear, prioritised roadmap.</p>
